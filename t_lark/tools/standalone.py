...
import t_lark
from t_lark.tools import lalr_argparser, build_lalr, make_warnings_comments
...
def gen_standalone(lark_inst, output=None, out=sys.stdout, compress=False):
    ...
    output('# The file was automatically generated by Lark v%s' % t_lark.__version__)
    output('__version__ = "%s"' % t_lark.__version__)
    output()
...
def main():
    ...
    parser = ArgumentParser(prog="prog='python -m t_lark.tools.standalone'", description="Lark Stand-alone Generator Tool",
